...
<body class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix ">
     ...
     <div id="bevanbakerimg">     </div>
     <div id="leadertext"><a href="?q=peter-bevan-baker-leader"> Peter Bevan Baker<br />Green Party Leader</a></div>
   ...
   <div id="welcome">
       <?php global $user;
		...
		if (!preg_match("/civicrm/i",$_SERVER['REQUEST_URI'],$matches)) {
		  $changelang = '<a href="' . $pth . '" lang="' . strtolower(substr($lng, 0, 2) ) . '">' . $lng . '</a>';
		}
		$uname="";
		if ($i18n_langpath == fr) {
			if ($user->uid) { // if user is logged in
		  		$uname =$user->name;
		  		$loginout = '<a href="/fr/logout">Fermer la session</a>';
			} else { // if not logged in
		  		$uname =  t("");
		  		$loginout = '<a href="/fr/user">Connexion</a>';
			}
		} else {
			if ($user->uid) { // if user is logged in
		  		$uname =$user->name;
		  		$loginout = '<a href="?q=logout">Logout</a>';
			} else { // if not logged in
		  		$uname =  t("");
		  		$loginout = '<a href="?q=user">Login</a>';
			}
		}
		?>
	    <?php print '<div id="welcome">' . $welcome . $uname . " | " . $loginout . '</div>';?>		  
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column two-sidebars"><div class="section">
