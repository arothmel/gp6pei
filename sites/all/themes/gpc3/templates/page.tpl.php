...
// $Id: page.tpl.php,v 1.4 2009/08/14 06:46:31 johnalbin Exp $
...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clearfix">
      ...
      <?php if ($header): ?>
	        <div id="header-blocks" class="clearfix region region-header block-menu-menu-secondary-links-gpc3"> 
          <?php print $header; ?>
    ...
    <div id="main" class="clearfix">
        <div id="main-inner" class="clearfix<?php if ($primary_links || $navbar) { print ' with-navbar'; } ?>">

      <?php if ($banner): ?>
      <?php if ($is_front): // display only if is_front ?>
        <div id="banner"><div id="banner-inner" class="clearfix region region-banner">
          <?php print $banner; ?>
        </div></div> <!-- /#banner-inner, /#banner -->
      <?php endif; ?> 
      <?php endif; ?>
      ...
      <div id="content"><div id="content-inner" class="clearfix">
        ...
        <?php if ($breadcrumb || $title || $tabs || $help || $messages): ?>
          <div id="content-header">
            <?php if ($title && !$banner) { ?>
              <div id="page-title">
                <h1 class="title jim"><?php print $title; ?></h1>
              </div>
            <?php } else { ?>
        ...
        <div id="content-area" class="two-sidebars">
          <?php print $content; ?>
        </div>
      ...
      <?php if ($primary_links || $navbar): ?>
        <div id="navbar"><div id="navbar-inner" class="clearfix region region-navbar">   <!-- Nice Menu 1 (navigation bar) needs style AAR -->
    ...
    <?php if ($footer || $footer_message || $secondary_links): ?>
      <div id="footer" class="clearfix"><div id="footer-inner" class="region region-footer">
